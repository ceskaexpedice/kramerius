...
public class NewIndexerProcessIndexObject {
    ...
    public static void main(String[] args) throws IOException {
        ...
        cz.incad.kramerius.fedora.RepositoryAccess rawRepositoryAccess = injector.getInstance(Key.get(cz.incad.kramerius.fedora.RepositoryAccess.class, Names.named("rawFedoraAccess")));

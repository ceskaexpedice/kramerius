...
<%@page import="cz.incad.kramerius.processes.LRProcess"%><html>

	<head></head>
	<body>
		<h3> Error </h3>
		<span>  ${processLogs.prevErrorOutputAHREF} ${processLogs.nextErrorOutputAHREF} </span>
		...
		<span> ${processLogs.prevStandardOutputAHREF}  ${processLogs.nextStandardOutputAHREF}  </span>

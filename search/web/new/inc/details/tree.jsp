...
--%>
    ...
    <div id="searchInside">
        ...
        <div>
            <input type="text" value="<fmt:message bundle="${lctx}">administrator.menu.searchinside</fmt:message>" id="insideQuery" size="25" class="searchQuery" onclick="checkInsideInput();" />
            <a href="javascript:searchInside();"><img border="0" align="top" alt="<fmt:message bundle="${lctx}">administrator.menu.searchinside</fmt:message>" src="img/lupa_orange.png" /></a>
        </div>

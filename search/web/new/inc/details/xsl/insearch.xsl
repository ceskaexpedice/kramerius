<xsl:stylesheet  version="1.0"
    ...
    <xsl:template name="doc">
        ...
        <td class="resultThumb" valign="top">
            <a>
                <xsl:attribute name="href">javascript:changeSelect('<xsl:value-of select="./str[@name='pid_path']"/>', '<xsl:value-of select="./str[@name='path']"/>');
                </xsl:attribute>
        ...
        <td class="resultText">
            <a><xsl:attribute name="href">javascript:changeSelect('<xsl:value-of select="./str[@name='pid_path']"/>', '<xsl:value-of select="./str[@name='path']"/>');</xsl:attribute><b><xsl:value-of select="./str[@name='dc.title']"/></b></a>&#160;

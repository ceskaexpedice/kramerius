...
<form name="searchForm" method="GET" action="./">
    <table class="header ui-corner-top-8" >
        <tbody><tr>
            <td width="230px">
                <a href="./?language=<c:out value="${param.language}" />" ><img src="img/logo_knav.png" border="0" /></a>
            </td>
            <td>
            ...
            <a href="javascript:showHelp('<c:out value="${param.language}" />');" ><fmt:message>nápověda</fmt:message></a> :: 
            <fmt:message>odkazy</fmt:message> :: 
            <br/>
                 :: <c:choose>

...
<xsl:stylesheet  version="1.0" 
    ...
    <xsl:template match="/mods:modsCollection/mods:mods" mode="info">
        ...
        <xsl:if test="mods:part">
            <a>
                <xsl:attribute name="href2">javascript:openPage('<xsl:value-of select="$pagePid" />', 'info:fedora/model:page', '<xsl:value-of select="mods:part/mods:detail[@type = 'pageNumber']/mods:number" />');</xsl:attribute>

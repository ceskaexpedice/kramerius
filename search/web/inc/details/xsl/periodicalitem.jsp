...
<xsl:stylesheet  version="1.0" 
    ...
    <xsl:output method="plain" encoding="UTF-8" omit-xml-declaration="yes" />
...
<%@page import="javax.servlet.jsp.jstl.fmt.LocalizationContext"%>
    ...
    <xsl:template match="/mods:modsCollection/mods:mods" mode="info">
        ...
        <!--Datum vydání ročníku: 1861	 Číslo ročníku: 1	(1/462)-->
            <xsl:value-of select="$volumeNumber" /><fmt:message bundle="${lctx}">Datum vydání</fmt:message> 
            <xsl:value-of select="mods:part/mods:date" />
            <fmt:message bundle="${lctx}">Číslo</fmt:message><xsl:value-of select="$volumeNumber" />

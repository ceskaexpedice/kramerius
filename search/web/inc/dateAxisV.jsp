...
<a href="javascript:doFilter();" ><img align="top" src="img/filter.png" border="0" alt="<fmt:message bundle="${lctx}">použit</fmt:message>" title="<fmt:message bundle="${lctx}">použit</fmt:message>" /></a>
</div>

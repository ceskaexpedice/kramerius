...
<div id="fullImageContainer" style="display:none;">
    <div id="djvuContainer" style="display:none;">
        <iframe src="djvu?uuid=${itemViewObject.imagePid}&outputFormat=RAW" frameborder="0" width="100%" height="100%"></iframe>
        <%--
    ...
    <div id="pdfContainer" style="display:none;">  
        <iframe src="djvu?uuid=${itemViewObject.imagePid}&outputFormat=RAW" width="100%" height="100%"></iframe>
        <%--

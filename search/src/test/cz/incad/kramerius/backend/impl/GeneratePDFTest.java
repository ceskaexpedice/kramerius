...
public class GeneratePDFTest extends TestCase {
	...
	public void testGen() throws IOException {
		...
		DecoratedOutputStream fos = new DecoratedOutputStream("test.pdf");
		...
		//instance.generatePDFOutlined("0eaa6730-9068-11dd-97de-000d606f5dc6",fos);
		instance.generatePDFOutlined("974d3b6c-e640-11de-a504-001143e3f55c", fos);

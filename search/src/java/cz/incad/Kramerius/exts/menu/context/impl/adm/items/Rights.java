...
public class Rights extends AbstractContextMenuItem implements AdminContextMenuItem {
...
//            "'" + SecuredActions.READ.getFormalName() + "', '" + SecuredActions.ADMINISTRATE.getFormalName() + "'", true));
    ...
    public String getRenderedItem() throws IOException {
        return super.renderContextMenuItem("javascript:securedActionsTableForCtxMenu('"+SecuredActions.READ.getFormalName()+","+SecuredActions.ADMINISTRATE.getFormalName()+"');", "administrator.menu.showrights");
    }

...
public class FedoraAccessProxyAkubraImpl extends AbstractFedoraAccess {
    ...
    @Inject
    public FedoraAccessProxyAkubraImpl(KConfiguration configuration, @Nullable AggregatedAccessLogs accessLog, @Named("akubraFedoraAccess")FedoraAccess acc, @Named("new-index")SolrAccess solrAccess, Provider<HttpServletRequest> provider, OnDemandIngest onDemIng) throws IOException {

    ...
    public void setRights(){
        ...
        try {
            ...
            if (rs.next()) {
                ...
                int updated = st.executeUpdate("insert into replicationright select id_cc, "+id+", 1 from m_monograph; ");
               log.info("Updated monographs: "+updated);
               updated = st.executeUpdate("insert into replicationright select id_cc, "+id+", 1 from p_periodical; ");

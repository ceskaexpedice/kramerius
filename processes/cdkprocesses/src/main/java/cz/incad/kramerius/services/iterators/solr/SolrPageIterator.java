...
public class SolrPageIterator extends AbstractSolrIterator{
    ...
    public static Element paginationQuery(Client client, String url, String mq, String offset, int rows, String filterQuery, String endpoint) throws IOException, SAXException, ParserConfigurationException {
    ...
    public void iterate(Client client, ProcessIterationCallback iterationCallback, ProcessIterationEndCallback endCallback) {
        try {
            ...
            do {
                Element element =  paginationQuery( client, address,masterQuery,  ""+offset, rows, filterQuery, endpoint);

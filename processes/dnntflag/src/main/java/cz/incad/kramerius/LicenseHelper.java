...
public class LicenseHelper {
    ...
    */
     ...
     */
    static List<String> getPidsOfOwnAncestorsWithoutAnotherSourceOfLicense(String pid, KrameriusRepositoryApi repository, IResourceIndex resourceIndex, String license) throws IOException, ResourceIndexException, RepositoryException {
        List<String> result = new ArrayList<>();
     ...
     */
    static boolean hasAnotherSourceOfLicense(String pid, String pidOfObjectNotCountedAsSource, String pidOfChildToBeIgnored, String license, KrameriusRepositoryApi repository, IResourceIndex resourceIndex) throws ResourceIndexException, RepositoryException, IOException {

...
public class DNNTWorker implements Runnable {
    ...
    private static void changeDNNTFlag(FedoraAccess fedoraAccess, String pid, boolean set) throws RepositoryException {
        try {
            ...
            repo.getObject(pid).addLiteral("dnnt",FedoraNamespaces.KRAMERIUS_URI, "true");

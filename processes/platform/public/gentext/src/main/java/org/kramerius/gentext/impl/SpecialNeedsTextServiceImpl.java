package org.kramerius.gentext.impl;
...
import org.kramerius.gentext.SpecialNeedsTextService;
...
public class SpecialNeedsTextServiceImpl implements SpecialNeedsTextService {

    public static final Logger LOGGER = Logger.getLogger(SpecialNeedsTextServiceImpl.class.getName());
    ...
    public File saveJobResultToTmpFile(String serviceApiBaseUrl, String pid, String exportServiceAuthHeader, JSONObject job) {
        try {
            ...
            File generatedTmpFile = File.createTempFile(createFilePrefix(filename, "kramerius_export_"), ".txt");

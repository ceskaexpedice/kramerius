...
@XmlRootElement(name = "CoreBibliographicDescriptionPeriodical")
public class CoreBibliographicDescriptionPeriodical {
    ...
    @XmlElement(name = "PhysicalDescription")
    protected List<PhysicalDescription> physicalDescription;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the physicalDescription property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPhysicalDescription().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<PhysicalDescription> getPhysicalDescription() {
        if (physicalDescription == null) {
            physicalDescription = new ArrayList<PhysicalDescription>();
        }

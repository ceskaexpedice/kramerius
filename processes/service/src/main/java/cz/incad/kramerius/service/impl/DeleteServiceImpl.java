...
public class DeleteServiceImpl implements DeleteService {
    ...
    void spawnIndexer(String pid, String parentPid) throws UnsupportedEncodingException {
        // TODO pepo scheduleSub IndexerProcessStarter.spawnIndexer(true, "Reindex parent after delete " + pid, parentPid.replace(INFO, ""));
    }

    void spawnIndexRemover(String pid) {
        // TODO pepo scheduleSub IndexerProcessStarter.spawnIndexRemover(pid);
    }

...
public abstract class WorkerFactory {
    ...
    public abstract Worker createWorker(ProcessConfig processConfig, ProcessIterator iteratorInstance, CloseableHttpClient client, ApacheHTTPRequestEnricher enricher, List<IterationItem> pids, WorkerFinisher finisher);

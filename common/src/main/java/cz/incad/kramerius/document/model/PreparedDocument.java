...
public abstract class AbstractRenderedDocument extends AbstractObject {
	...
	/**
	 * Sets title page
	 * @param uuidTitlePage Title page
	 */
	 ...
	 * @param outlineItemRoot New outline root
	 */
	...
	/**
	 * Sets main title
	 * @param uuidMainTitle main title
	 */
	@Deprecated
	 ...
	 * @param uuid Specify objects to remove
	 */
	...
	/**
	 * Sets the pids path
	 * @param objectPidsPath New pids path
	 */

...
public class MPTStoreService implements IResourceIndex {
    ...
    @Override
    public ArrayList<String> getParentsPids(String uuid) throws ResourceIndexException {
    ...
    @Override
    public ArrayList<String> getPidPaths(String pid) throws ResourceIndexException {
        logger.info(pid);
        ArrayList<String> resList = new ArrayList<String>();
    ...
    @Override
    public ArrayList<String> getObjectsInCollection(String collection, int limit, int offset) throws ResourceIndexException {
        ArrayList<String> resList = new ArrayList<String>();
        Connection c = null;
        PreparedStatement s = null;
        ResultSet r = null;

...
public class JackRabbitRepoAccessImpl extends AbstractFedoraAccess {
	...
	static String JACKRABBIT_FOLDER = System.getProperty("jackrabbit.folder", (System.getProperty("user.home")+File.separator+"jck_repo"));
	...
	private synchronized void namespaces(Session session) throws AccessDeniedException, NamespaceException, UnsupportedRepositoryOperationException, RepositoryException {

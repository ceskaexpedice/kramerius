...
public class WizardMockLPProcess {
    ...
    public static void process(@ParameterName("inputFolder") File inputFolder, @ParameterName("processName") String processName) {
        ...
        LOGGER.log(Level.INFO,"Sposutim parametrizovany proces");

        LOGGER.info("inputFolder is :"+inputFolder);
        LOGGER.info("input folder class:"+inputFolder.getClass().getName());

        LOGGER.info("..");

        LOGGER.info("processName is :"+processName);
        LOGGER.info("processName  class:"+processName.getClass().getName());
    }
}

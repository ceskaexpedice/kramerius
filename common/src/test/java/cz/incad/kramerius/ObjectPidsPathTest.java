...
public class ObjectPidsPathTest {
    ...
    @Test
    public void testEhanceByCollection() throws JSONException, IOException, NoSuchMethodException, IllegalAccessException, CollectionException, ParserConfigurationException, SAXException {
        
        InputStream itemStream = ObjectPidsPathTest.class.getResourceAsStream("objectpidpathrelsext.xml");
        Document document = XMLUtils.parseDocument(itemStream, true);
        ...
        Assert.assertEquals(path.injectCollections(colGet,fa).getRoot(), "vc:d3f011e3-f1fd-4025-a907-68a860460841");
        Assert.assertEquals(path.injectCollections(colGet,fa).injectRepository().getRoot(), "uuid:1");
    }
    ...
    public void testEhanceByCollection3() throws JSONException, IOException, NoSuchMethodException, IllegalAccessException, CollectionException {
        ...
        replay( colGet, fa);
        ObjectPidsPath cols = p.injectCollections(colGet,fa);

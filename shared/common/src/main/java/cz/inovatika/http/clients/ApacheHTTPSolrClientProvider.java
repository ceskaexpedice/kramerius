     ...
     */
    public class ApacheHTTPSolrClientProvider implements Provider<CloseableHttpClient> {

        public static final Logger LOGGER = Logger.getLogger(ApacheHTTPSolrClientProvider.class.getName());
        ...
        /**
         * Constructs an instance of ApacheHTTPSolrClientProvider.
        ...
        public ApacheHTTPSolrClientProvider() {
            ...
            LOGGER.info(String.format("Final RequestConfig state: %s", requestConfig.toString()));

            LOGGER.info(String.format("Apache Client Configured: [ConnectTimeout: %s, ResponseTimeout: %s, CookieSpec: %s]",
                    requestConfig.getConnectTimeout().toString(),
                    requestConfig.getResponseTimeout().toString(),
                    requestConfig.getCookieSpec().toString()));

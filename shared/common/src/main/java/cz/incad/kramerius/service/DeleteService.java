...
public interface DeleteService {
     ...
     * @throws IOException
     */
    public void deleteTree(AkubraRepository internalAPI, String pid, String pidPath, String message, boolean deleteEmptyParents, boolean spawnIndexer) throws IOException, ResourceIndexException, SolrServerException;

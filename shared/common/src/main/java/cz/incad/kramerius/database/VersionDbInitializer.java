 ...
 * @author pavels
 */
public class VersionDbInitializer {

    static Logger LOGGER = Logger.getLogger(VersionDbInitializer.class.getName());
    ...
    private static void createDBVersionsTable(Connection connection) throws IOException, SQLException {
        InputStream is = VersionDbInitializer.class.getResourceAsStream("res/initversions.sql");

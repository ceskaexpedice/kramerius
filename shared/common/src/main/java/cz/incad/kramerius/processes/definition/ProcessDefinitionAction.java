...
public class ProcessDefinitionAction {
	...
	public static final ProcessDefinitionAction LOGS_ACTION = new ProcessDefinitionAction("inc/admin/_processes_outputs.jsp","logs","administrator.processes.logs");
	...
	private ProcessDefinitionAction(String actionURL, String name, String rbkey) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProcessDefinitionAction other = (ProcessDefinitionAction) obj;
		if (actionURL == null) {

...
public class ExportServiceImpl implements ExportService {
    ...
    public static void main(String[] args) throws IOException, TransformerException, SAXException, ParserConfigurationException {
        ...
        com.google.inject.Injector injector = com.google.inject.Guice.createInjector(new cz.incad.kramerius.solr.SolrModule(), new ResourceIndexModule(), new cz.incad.kramerius.fedora.RepoModule(), new cz.incad.kramerius.statistics.NullStatisticsModule());

...
public class ProcessDefinitionImpl implements ProcessDefinition {
    ...
    private List<ProcessDefinitionAction> actions = new ArrayList<ProcessDefinitionAction>();
    ...
    public ProcessDefinitionAction getLogsAction() {
        return ProcessDefinitionAction.LOGS_ACTION;
    }

    public List<ProcessDefinitionAction> getActions() {
        return new ArrayList<ProcessDefinitionAction>(this.actions);
    }
    ...
    private void actions(Node item) {
        ...
        for (int i = 0, ll = nodes.getLength(); i < ll; i++) {
            ...
            if (chItem.getNodeType() == Node.ELEMENT_NODE) {
                ProcessDefinitionAction action = new ProcessDefinitionAction();
    ...
    private String actionsToString(List<ProcessDefinitionAction> actions) {
        StringBuilder builder = new StringBuilder();
        builder.append('[');
        for (ProcessDefinitionAction item : actions) {

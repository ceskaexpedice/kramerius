...
public class MonographUnitDecorate extends  AbstractDetailDecorator {
    ...
    public static final String MONOGRAPH_UNIT = AbstractItemDecorator.key("DETAILS.MONOGRAPHUNIT");
	...
	public boolean apply(JSONObject jsonObject, String context) {
		...
		return tpath.isParsed() && tpath.getRestPath().isEmpty() && m != null && m.equals("monographunit");
	}

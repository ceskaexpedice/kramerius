...
public class ActionNotAllowed extends WebApplicationException{
    ...
    public ActionNotAllowed(String message) {
        super(Response.status(HttpServletResponse.SC_FORBIDDEN).entity(ExceptionMessageBuilder.createErrorMessage(401,message)).type(MediaType.APPLICATION_JSON).build());
    }
}

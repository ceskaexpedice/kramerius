...
public enum MetadataExport {
    ...
    oaiDc("oai_dc",
		...
		@Override
		public List<Element> perform(HttpServletRequest request, FedoraAccess fa, Document owningDocument, String oaiIdentifier,OAISet set) {
			try {
    ...
    edm("edm","http://www.europeana.eu/schemas/ese/","") {
		...
		@Override
        public List<Element> perform(HttpServletRequest request, FedoraAccess fa, Document owningDocument,
                    ...
                    try {
                        ...
                        if (redirectHandler != null) {
                            ...
                            if (directStreamDC != null) {
                                ...
                                metadataProvider(instances, solrDataByPid, oaiRec, provider, defaultDataProvider);
            ...
            "http://registrdigitalizace.cz/schemas/drkramerius/v4/") {
                ...
                public List<Element> perform(HttpServletRequest request, FedoraAccess fa, Document owningDocument,
                    ...
                    try {
                        ...
                        String model = RelsExtHelper.getModel(relsExt.getDocumentElement());
                        ...
                        Document biblio = fa.getBiblioMods(pid);
                        Element biblioRoots = (Element) owningDocument.adoptNode(biblio.getDocumentElement());
                        drDescriptor.appendChild(biblioRoots);

                        List<Pair<String,String>> relations = RelsExtHelper.getRelations(relsExt.getDocumentElement());
    ...
    public static ProxyItemHandler findRedirectHandler(org.w3c.dom.Document solrDataByPid, SolrAccess solrAccess, Provider<User> userProvider,  Provider<CloseableHttpClient> apacheClient, Instances instances, HttpServletRequest request, String pid, String source) throws LexerException, IOException {
        if (source == null) {
            source = defaultDocumentSource(solrDataByPid);
        }
    ...
    private static void metadataProvider(Instances instances, Document solrDataByPid, OAIRecord oaiRec, Element provider, String defaultValue) {
    ...
    /** CDK side */
    public abstract List<Element> performOnCDKSide(SolrAccess solrAccess, Provider<User> userProvider, Provider<CloseableHttpClient> apacheClientProvider, Instances instances, HttpServletRequest request, Document owningDocument, OAIRecord oaiRec, OAISet set, CDKRequestCacheSupport cacheSupport);
    
	/** Local kramerius */
    public abstract List<Element> perform(HttpServletRequest request, FedoraAccess fa, Document owningDocument, String oaiIdentifier, OAISet set);
